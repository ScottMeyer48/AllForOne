...
$opts = array(
	...
	'roots' => array(
		...
		array(
			...
			'path'          => '../../../datausers/files/',                 // path to files (REQUIRED)
			'URL'           => dirname($_SERVER['PHP_SELF']) . '/../../../datausers/files/', // URL to files (REQUIRED)
			'trashHash'     => 't1_Lw',                     // elFinder's hash of trash folder
			'winHashFix'    => DIRECTORY_SEPARATOR !== '/', // to make hash same to Linux one on windows too
			'uploadDeny'    => array('all'),                // All Mimetypes not allowed to upload
			'uploadAllow'   => array('image', 'text/plain','application/vnd.ms-excel','application/msword','application/vnd.openxmlformats-officedocument.wordprocessingml.document','application/vnd.openxmlformats-officedocument.spreadsheetml.sheet','application/pdf','application/x-7z-compressed','application/zip'), // allowed to upload // 'image/x-ms-bmp', 'image/gif', 'image/jpeg', 'image/png', 'image/x-icon'
		...
		array(
			'id'            => '1',
			'driver'        => 'Trash',
			'path'          => '../../../datausers/files/.trash/',
			'tmbURL'        => dirname($_SERVER['PHP_SELF']) . '/../../../datausers/files/.trash/.tmb/',
			'winHashFix'    => DIRECTORY_SEPARATOR !== '/', // to make hash same to Linux one on windows too
